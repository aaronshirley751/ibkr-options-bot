...
class StubBroker:
    ...
    def market_data(self, symbol_or_contract):
        ...
        # options
        return StubQuote(getattr(symbol_or_contract, "symbol", "OPT"), last=2.5, bid=2.45, ask=2.55, volume=5000)
...
def test_run_cycle_with_stubbed_broker_no_errors(tmp_path, monkeypatch):
    ...
    settings = {
        "symbols": ["SPY"],
        "mode": "growth",
        "risk": {"max_risk_pct_per_trade": 0.01, "stop_loss_pct": 0.2, "take_profit_pct": 0.3},
